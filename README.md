...
- Create two apps on Fly, one for staging and one for production:
  ...
  ```sh
  fly apps create nfl-playoff-picks-4c97
  fly apps create nfl-playoff-picks-4c97-staging
  ```
...
- Add a `SESSION_SECRET` to your fly app secrets, to do this you can run the following commands:
  ...
  ```sh
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app nfl-playoff-picks-4c97
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app nfl-playoff-picks-4c97-staging
  ```

  > **Note:** When creating the staging secret, you may get a warning from the Fly CLI that looks like this:
  >
  > ```
  > WARN app flag 'nfl-playoff-picks-4c97-staging' does not match app name in config file 'nfl-playoff-picks-4c97'
  > ```
  >
...
- Create a database for both your staging and production environments. Run the following:
  ...
  ```sh
  fly postgres create --name nfl-playoff-picks-4c97-db
  fly postgres attach --app nfl-playoff-picks-4c97 nfl-playoff-picks-4c97-db

  fly postgres create --name nfl-playoff-picks-4c97-staging-db
  fly postgres attach --app nfl-playoff-picks-4c97-staging nfl-playoff-picks-4c97-staging-db
  ```
